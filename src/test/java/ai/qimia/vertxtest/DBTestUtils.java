...
public class DBTestUtils {
  ...
  public static void executeSQLQuery(String sqlQuery, PostgreSQLContainer<?> postgresContainer) throws SQLException {
    executeSQLQuery(sqlQuery, postgresContainer.getJdbcUrl(), postgresContainer.getUsername(), postgresContainer.getPassword());
  }

  public static void executeSQLQueryFromResource(String sqlResource, PostgreSQLContainer<?> postgresContainer) throws IOException, SQLException {
    executeSQLQueryFromResource(sqlResource, postgresContainer.getJdbcUrl(), postgresContainer.getUsername(), postgresContainer.getPassword());
  }
