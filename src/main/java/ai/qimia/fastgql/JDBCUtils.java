...
public class JDBCUtils {
  ...
  public static Single<List<Map<String, Object>>> getGraphQLResponse(DataFetchingEnvironment environment, Pool client) {
  ...
  public static TableSchema<?> getTableSchema(DatabaseMetaData databaseMetaData, Statement statement, String tableName) throws SQLException {
    ...
    ResultSet rowsResultSet = statement.executeQuery(String.format("SELECT * FROM %s LIMIT 0", tableName));
    ...
    TableSchema<?> table = new TableSchema<>(tableName, primaryKeyName, sqlTypeToClass.get(primaryKeyType));
  ...
  public static Map<String, TableSchema<?>> getTableSchemas(Connection connection) throws SQLException {
    DatabaseMetaData databaseMetaData = connection.getMetaData();
    Statement statement = connection.createStatement();
    ResultSet getTablesResultSet = databaseMetaData.getTables(null, null, null, new String[]{"TABLE"});
